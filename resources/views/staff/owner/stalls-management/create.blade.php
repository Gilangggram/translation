    ...
    <div class="flex flex-col gap-2">
        ...
        <form wire:submit="save" class="flex flex-col gap-2">
            ...
            <div class="flex flex-col bg-white rounded-lg w-full p-4 border border-[#E0D2BB] gap-4">
                ...
                <div>
                    <h3 class="font-manrope text-sm font-medium text-[#532E1C]">Akun Stall</h3>
                    <p class="font-manrope text-xs text-[#80543F]">Kredensial login untuk pemilik stall</p>
                </div>
                    ...
                    <div class="flex flex-col gap-1">
                        ...
                        <div class="flex items-end gap-2">
                            <div class="w-full flex flex-col items-start gap-1">
                                ...
                                <input type="text"
                                    id="password"
                                    wire:model="stallForm.password"
                                    placeholder="Password (min. 6 karakter)"
                                    class="w-full py-2 bg-[#F5F2F0] text-xs font-manrope text-[#2C180F] border border-[#2C180F] rounded-md outline-none
                                    placeholder:text-[#C5A880] focus:ring-1 focus:ring-[#532E1C] transition"/>
                                @error('stallForm.password') <span class="text-xs text-[#AD1614]"><i class="bi bi-exclamation-circle text-xs me-1"></i>{{ $message }}</span> @enderror
                            </div>
                        ...
                        <p class="font-manrope text-xs text-[#80543F]">Password akan diberikan ke pemilik stall untuk login pertama kali.</p>
            ...
            <button type="submit" class="w-full font-manrope text-sm font-semibold text-white bg-[#442313] py-2 rounded-lg cursor-pointer">
                <span wire:loading.remove wire:target="save">Buat Stall</span>
