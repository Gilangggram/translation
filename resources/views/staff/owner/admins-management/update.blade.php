@section('title', 'Perbarui Akun Admin')
    ...
    <div class="flex flex-col gap-2">
        ...
        <form wire:submit="update" class="flex flex-col gap-2">
            ...
            <div class="flex flex-col bg-white rounded-lg w-full p-4 border border-[#E0D2BB] gap-4">
                ...
                <div>
                    <h3 class="font-manrope text-sm font-medium text-[#532E1C]">Data Admin</h3>
                    <p class="font-manrope text-xs text-[#80543F]">Data Kredensial Admin </p>
                </div>
                ...
                <div class="flex flex-col gap-4">
                    <div class="grid grid-cols-2 gap-4">
                        <div class="flex flex-col items-start gap-1">
                            ...
                            @error('adminForm.phone_number') <span class="text-xs text-[#AD1614]"><i class="bi bi-exclamation-circle text-xs me-1"></i>{{ $message }}</span> @enderror
                        </div>
                        ...
                        <div class="flex flex-col items-start gap-1">
                            ...
                            <input type="text"
                                ...
                                class="w-full py-2 bg-[#F5F2F0] text-xs font-manrope text-[#2C180F] border border-[#2C180F] rounded-md outline-none
                                placeholder:text-[#C5A880] focus:ring-1 focus:ring-[#532E1C] transition"/>
                            @error('adminForm.name') <span class="text-xs text-[#AD1614]"><i class="bi bi-exclamation-circle text-xs me-1"></i>{{ $message }}</span> @enderror
                        </div>
            ...
            <button type="submit" class="w-full font-manrope text-sm font-semibold text-white bg-[#442313] py-2 rounded-lg cursor-pointer">
                <span wire:loading.remove wire:target="update">Perbarui Akun</span>
